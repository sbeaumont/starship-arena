...
4. **Open on purpose:** `/games`, `/{game}/overview`, `/ship-types` and `/manual` need no login.
   The scoreboard, the ship stats and the rules are public; positions and orders are not.
