"""Snapshots and events per tick, attached to the object they belong to.

Tick, History and TickHistory are defined in docs/glossary.md."""

from arena.engine.objects.event import ScanEvent, HitEvent
