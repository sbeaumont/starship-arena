...
root the servers and the console run on, holding `games/`, `archived/`, `registering/` and
`solo-games/`, all of it gitignored. Point `GAME_DATA_DIR` at it and play with whatever you like; the suite never sees
it.
